defmodule ShareCircleWeb.UserAuth do
  @moduledoc "Plugs and helpers for session-based authentication."

  use ShareCircleWeb, :verified_routes
  ...
  @remember_me_cookie "_share_circle_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ShareCircleWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
